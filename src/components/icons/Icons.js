...
export const UserActiveGroupIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => (
    <svg
        datae2e=""
        width={width}
        height={height}
...
export const LiveIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => (
    <svg
        ...
        height={height}
        fill="currentColor"
        className="css-dr8s99-StyledLiveIcon egn9vfa4"
        viewBox="0 0 48 48"
        xmlns="http://www.w3.org/2000/svg"
    >
...
export const LiveActiveIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => (
    <svg
        fill="currentColor"
        className="css-3qcg1j-StyledLiveIconFill egn9vfa5"
        viewBox="0 0 48 48"
        xmlns="http://www.w3.org/2000/svg"
        width={width}
        height={height}
